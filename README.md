...
the used tool wa ' JUnit Test Case in Eclipse', link to the sreenshot of applying the tool (https://github.com/Rubaalmashhuri/survey-system/blob/master/codeCoverage.PNG)
